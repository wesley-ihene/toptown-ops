...
_LABEL_RULES: dict[str, dict[str, tuple[str, ...]]] = {
    "sales": {
        ...
        "Cash_Over": ("cash over", "c over", "c/over", "cash_over", "over", "cash variance over"),
        "Cash_Down": ("cash down", "c down", "c/down", "cash_down", "down", "cash variance down"),
    ...
    "attendance": {
        ...
        "P": ("p", "present"),
        "P_HALF": ("p half", "p half day", "present half day", "p 1 2 day"),
        "OFF": ("off", "off duty"),
