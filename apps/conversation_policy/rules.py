...
_REASON_TEXT: Final[dict[str, str]] = {
    ...
    "mixed_report_split_not_safe": "mixed report types detected",
    "mixed_child_requires_review": "one split item still needs review",
    "missing_branch": "branch missing or unclear",
    "missing_date": "date missing or unclear",
    "supervisor_control_invalid_format": "supervisor control format needs correction",
    "correction_request_requires_full_report": "full replacement bale rows are required",
    ...
    "duplicate_message": "duplicate report detected",
    "duplicate_message_id": "duplicate report detected",
    "duplicate_raw_sha256": "duplicate report detected",
...
_FALLBACK_REASON_TEXT: Final[dict[str, str]] = {
    ...
    "duplicate_ack": "this report was already received",
