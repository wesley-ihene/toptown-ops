"""Build branch daily analytics from structured sales and staff records."""
...
from apps.branch_daily_analytics_agent.worker import process_work_item
from packages.signal_contracts.work_item import WorkItem


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build one branch daily analytics file.")
